...
public class Controller implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch (actionCommand) {
            ...
            case "ALDATU":
                try {
                if (!view.jTextFieldHerria.getText().equals("")) {
                    ArrayList<Herria> d = model.irakurri();
                    model.ezabatu(d.get(view.jTableHerriak.getSelectedRow()).getIzena());
                    view.herrienTableModela.datuak = model.irakurri();
                    h = new Herria(view.jTextFieldHerria.getText(), view.jComboBoxProbintzia.getSelectedItem().toString(),
                            view.jCheckBoxHondartza.isSelected(), view.jTextAreaOharrak.getText());
                    model.txertatu(h);
                    view.herrienTableModela.datuak = model.irakurri();
                    view.herrienTableModela.fireTableChanged(null);
                    ...
                    System.out.println("Ez dago aldaketa egiteko herri berririk idatziata");
                }
                } catch (Exception E) {
                    System.out.println("Arazoa aldaketa egiterako orduan");
                }
                break;
        }
    }
